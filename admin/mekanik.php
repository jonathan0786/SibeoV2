    ...
    <div class="row g-0">
        ...
        <div class="col-md-9 col-lg-10 main-wrapper">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="tambah_mekanik.php" class="btn btn-add">
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_assoc($query_mekanik)) {
                                $shift = isset($data['shift']) ? $data['shift'] : 'Pagi';
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bold" style="color: #0f172a;"><?= htmlspecialchars($data['nama']); ?></td>
                                    <td class="fw-medium text-secondary"><?= htmlspecialchars($data['kepegawaian']); ?></td>
                                    <td><span class="badge bg-secondary bg-opacity-10 text-secondary border border-secondary border-opacity-25 rounded-3 px-3 py-1.5"><?= htmlspecialchars($data['spesialisasi']); ?></span></td>
                                    <td class="text-center"><?= $badge; ?></td>
                                    <td class="text-center">
                                        <a href="edit_mekanik.php?id=<?= $data['id_mekanik']; ?>" class="btn btn-sm btn-light text-primary me-1 rounded-3">
                                            <i class="fa-solid fa-pen-to-square"></i>
                                        </a>
                                        <a href="hapus_mekanik.php?id=<?= $data['id_mekanik']; ?>" class="btn btn-sm btn-light text-danger rounded-3" onclick="return confirm('Apakah yakin ingin menghapus data mekanik ini?')">
