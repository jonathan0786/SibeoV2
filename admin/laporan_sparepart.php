...
<div class="layout-wrapper">
    <!-- PANEL SIDEBAR -->
    <div class="sidebar-panel no-print">
        ...
        <div class="menu-container">
            ...
            <a href="laporan_sparepart.php" class="nav-link active"><i class="bi bi-box-seam"></i>Laporan Sparepart</a>
        </div>
    ...
    <div class="main-canvas">
        ...
        <!-- Header Print (Only shown when printing) -->
