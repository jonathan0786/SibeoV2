    ...
    <div class="row g-0">
        ...
        <div class="col-md-9 col-lg-10 main-wrapper">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="tambah_pelanggan.php" class="btn btn-add">
                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_assoc($query_pelanggan)) {
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bold text-primary"><?= $data['nomor_pelanggan']; ?></td>
                                    <td class="fw-semibold" style="color: #0f172a;"><?= $data['nama_lengkap']; ?></td>
                                    <td><?= $data['nik']; ?></td>
                                    <td><?= $data['no_telepon']; ?></td>
                                    <td class="text-center">
                                        <a href="edit_pelanggan.php?id=<?= $data['id_pelanggan']; ?>" class="btn btn-sm btn-light text-primary me-1 rounded-3" title="Edit Data">
                                            <i class="fa-solid fa-pen-to-square"></i>
                                        </a>
                                        <a href="hapus_pelanggan.php?id=<?= $data['id_pelanggan']; ?>" class="btn btn-sm btn-light text-danger rounded-3" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')" title="Hapus Data">
